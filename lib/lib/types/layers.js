...
exports.layerGroups = [
    {
        ...
        layers: exports.layers.filter(layer => layer.group === 'demographics-group')
    },
    {
        id: 'housing-group',
        title: 'Housing',
        description: 'Housing and dwelling data',
        layers: exports.layers.filter(layer => layer.group === 'housing-group')
    },
    {
        id: 'income-group',
        title: 'Income',
        description: 'Household income data',
        layers: exports.layers.filter(layer => layer.group === 'income-group')
    },
    {
        id: 'spending-group',
        title: 'Spending',
        description: 'Household spending data',
        layers: exports.layers.filter(layer => layer.group === 'spending-group')
    }
];
