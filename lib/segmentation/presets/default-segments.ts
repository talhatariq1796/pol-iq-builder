...
export const defaultSegments: SegmentDefinition[] = [
  {
    ...
    description:
      "Moderate, college-educated suburban voters in competitive precincts - prime persuasion targets",
  ...
  },
  {
    ...
    description:
      "Dense urban areas with young renters - high persuasion potential",
    createdAt: "2024-01-01T00:00:00Z",
    updatedAt: "2024-01-01T00:00:00Z",
    filters: {
      demographic: {
