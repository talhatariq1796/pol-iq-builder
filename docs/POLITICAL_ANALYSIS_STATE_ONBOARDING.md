...
| Per-precinct election history (PDF / API) | `public/data/political/pensylvania/pa_precinct_election_history.json` | **~9,148** precincts with `elections` keyed by date (`2020-11-03`, `2022-11-08`, `2024-11-05`); generated by same command as targeting |
