                            ...
                            <tbody>
                                ...
                                <tr className="border-b border-purple-200 bg-purple-50">
                                    ...
                                    <td className="text-right py-3 px-2">
                                        <Badge
                                            variant="outline"
                                            className={`font-semibold ${getGIMStatus(property.gim || property.gross_income_multiplier || 0) === 'good'
                                ...
                                {sortedComparables.map((comp, index) => (
                                    <tr key={index} className="border-b border-gray-100 hover:bg-gray-50">
                                        ...
                                        <td className="text-right py-3 px-2">
                                            <Badge
                                                variant="outline"
                                                className={`font-medium ${getGIMStatus(comp.gim || comp.gross_income_multiplier || 0) === 'good'
                                                        ? 'bg-green-50 text-green-700 border-green-200'
